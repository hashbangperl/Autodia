...
autodia.pl -o outfile.xml         : use outfile.xml as output file (otherwise uses autodia.out.dia)
...
=item C<autodia.pl -o outfile.xml         : use outfile.xml as output file (otherwise uses autodia.out.dia)>
